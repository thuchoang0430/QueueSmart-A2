function UserDashboard() {
  return (
    <>
      <div className="w-screen h-screen bg-slate-100 grid grid-cols-[0.3fr_1.7fr]">
        <aside className="bg-slate-900 h-full px-5 py-3 text-white space-y-5">
          ...
          <div className="bg-slate-700 px-3 py-3 rounded-2xl ring ring-slate-600 shadow-sm">
            ...
            <p className="text-slate-300 text-xs">
              Build by our team for the QueueSmart front-end project
            </p>
          </div>
          ...
          <div className="bg-slate-700 px-3 py-3 rounded-2xl ring ring-slate-600 shadow-sm space-y-2">
            ...
            <div className="text-center">
              <button className="bg-white text-slate-900 px-6 py-2 rounded-2xl">
                View Team
              </button>
            </div>
          </div>
        ...
        <div>
          <div className="bg-white flex px-10 py-10 justify-between">
            <div className="text-slate-600">
              ...
              <p className="text-slate-600 text-xl">
                A smart queue management product build by our team
              </p>
            </div>
            <div className="flex gap-3 justify-center items-center text-xl border border-slate-200 px-5 py-5 rounded-2xl shadow-sm">
          ...
          <div className="w-[90%] max-w-6xl bg-white rounded-2xl grid grid-cols-[1.4fr_0.6fr] mt-5 border border-slate-100 shadow-sm mx-auto overflow-hidden">
          ...
          <div className="w-[90%] max-w-6xl bg-white rounded-2xl mt-5 border border-slate-100 shadow-sm mx-auto">
            ...
            <div className="grid grid-cols-4 gap-5 px-3 py-3">
              <div className="border border-slate-100 px-2 py-3 rounded-2xl bg-blue-50 flex gap-4 justify-center items-center">
                ...
                <div>
                  <p className="font-bold">Anly L Do</p>
            ...
            <div className="flex justify-between">
              <div className="space-y-2">
                ...
                <p className="text-sm text-slate-600">
                  ...
                  your notification for status updates.
                </p>
              </div>
          ...
          <div className="grid grid-cols-3 gap-3 w-[90%] max-w-6xl bg-white rounded-2xl mt-5 border border-slate-100 shadow-sm mx-auto px-5 py-5">
            <div className="bg-white border border-slate-200 px-5 py-5 rounded-2xl shadow-sm">
              <div className="flex justify-between">
                ...
                <p className="px-2 py2 bg-blue-50 text-blue-600 rounded-2xl font-bold">
                  Active
                </p>
              </div>
              <div>
            ...
            <div className="bg-white border border-slate-200 px-5 py-5 rounded-2xl shadow-sm">
              <div className="flex justify-between">
                <p className="text-slate-600">⏰ Estimate Wait</p>
              </div>
              <div>
                <div className="flex gap-3 items-center">
                ...
                <p className="text-slate-600">
                  Times may change based on service speed
                </p>
              </div>
            </div>
            <div className="bg-white border border-slate-200 px-5 py-5 rounded-2xl shadow-sm">
              ...
              <div>
                <p className="font-bold text-3xl">3</p>
                <p className="text-slate-600">Service currently open</p>
              </div>
            </div>
          </div>
          <div className="grid grid-cols-[1.3fr_0.7fr] w-[90%] max-w-6xl bg-white rounded-2xl mt-5 border border-slate-100 shadow-sm mx-auto px-5 py-5 gap-5">
            ...
            <div className="border border-slate-200 rounded-2xl shadow-sm px-5 py-5 space-y-5">
              <div className="flex justify-between">
                ...
                <div>
                  <p className="bg-blue-50 text-blue-600 font-bold rounded-full">
                    3
                  </p>
                </div>
              </div>
          ...
          <section className="w-[90%] max-w-6xl bg-white rounded-2xl mt-5 border border-slate-100 shadow-sm mx-auto px-5 py-5">
