            ...
            <div>
              ...
              <div className="mt-10">
                <p className="text-slate-600">
                  QueueSmart helps you wait less and live more. Sign in and
          ...
          >
            ...
            <div className="mt-5 text-center">
              ...
              <p className="mt-2 text-sm text-slate-500">
                Sign in to continue with QueueSmart.
              </p>
            </div>
            ...
            <div className="mt-9 space-y-5">
              ...
              <div className="flex flex-col sm:flex-row sm:justify-between gap-3">
                ...
                <button
                  type="button"
                  className="text-blue-600 text-left sm:text-right"
                >
                  Forgot my password?
                </button>
              </div>
              ...
              <div className="flex items-center gap-4">
                <div className="border flex-1 border-slate-300 h-px"></div>
